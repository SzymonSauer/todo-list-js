let todoInput; //place for activity
let errorInfo; //information about errors
let addBtn; //button which adds new elements
let ulList; //list of tasks
let neweTodo; //new task
let popup; //popup
...
const addNewTodo = () => {
	if (todoInput.value !== '') {
		...
		errorInfo.textContent = 'Add new task...';
	}
};
...
const deleteTodo = (e) => {
	...
	if (allTodos.length === 0) {
		errorInfo.innerText = 'No tasks on the list...';
	}
};
